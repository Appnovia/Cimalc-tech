...
export default function AboutPage() {
  return <main>
    ...
    <section className="mx-auto grid max-w-[1440px] gap-12 px-4 py-16 md:grid-cols-[.8fr_1.2fr] md:px-8 md:py-24">
      ...
      <div className="rounded-2xl border border-border bg-surface p-6 shadow-sm md:p-10"><p className="text-2xl font-semibold leading-relaxed text-default md:text-3xl">â€œTell us what you need it to do. Weâ€™ll help you work out what makes sense.â€</p><div className="mt-8 flex items-center gap-3 border-t border-border pt-5"><span className="grid h-10 w-10 place-items-center rounded-full bg-brand text-sm font-bold text-white">C</span><div><p className="text-sm font-semibold text-default">The Cimalc Tech team</p><p className="text-xs text-muted">Here when you need a second opinion</p></div></div></div>
    </section>
